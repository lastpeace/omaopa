...
@section('content')
    <div class="flex ">
        <div class="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[150px] overflow-y-auto text-center bg-yellow-300">
            ...
            <div
                class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-yellow-700 text-yellow-700 item">
                <i class="bi bi-house-door-fill hover:text-yellow-300"></i>
                <a href="{{ route('admin.dashboard') }}" class="text-[15px] ml-4 text-yellow-700 font-bold">Home</a>
            </div>
            <div
                class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-yellow-700 text-yellow-700">
                <i class="bi bi-bookmark-fill"></i>
                <a href="{{ route('admin.products.index') }}" class="text-[15px] ml-4 text-yellow-700 font-bold">Menu</a>
            </div>
            <div
                class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-yellow-700 text-yellow-700">
                <i class="bi bi-bookmark-fill"></i>
                <a class="text-[15px] ml-4 text-yellow-700 font-bold"
                    href="{{ route('admin.reservations.index') }}">Pesanan</a>
            </div>
            ...
            <div
                ...
                <form id="logout-form" method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="text-[15px] ml-4 text-yellow-700 font-bold">Logout</button>
                </form>
            </div>
            ...
            <div class="w-full flex flex-col md:flex-row-reverse item-center justify-center">
                <div class="w-full md:w-[347px] px-4 py-2 mt-4 md:mt-0">
                    ...
                    <button id="makananBtn"
                        class="w-40 h-[42px] bg-gray-200 text-zinc-600 rounded-[50px] mb-2 md:mb-0">Ogura</button>
                </div>
            </div>
